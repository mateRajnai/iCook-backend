...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/recipe/{id}/comments/{userId}").authenticated()
                ...
                .addFilterBefore(new JwtTokenFilterForBlackList(blacklist, jwtTokenServices), UsernamePasswordAuthenticationFilter.class)
                .logout()
                    .addLogoutHandler(new JwtDoBlackListing(blacklist, jwtTokenServices))
